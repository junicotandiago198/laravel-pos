      ...
      if ((this.$element.trigger(f), !f.isDefaultPrevented())) {
        ...
        return this.runValidators(c).done(function (b) {
          c.data('bs.validator.errors', b),
            ...
            (e && b.toString() === e.toString()) || ((f = b.length ? a.Event('invalid.bs.validator', { relatedTarget: c[0], detail: b }) : a.Event('valid.bs.validator', { relatedTarget: c[0], detail: e })), g.$element.trigger(f)),
            g.toggleSubmit(),
